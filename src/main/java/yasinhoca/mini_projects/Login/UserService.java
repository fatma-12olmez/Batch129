package yasinhoca.mini_projects.Login;
...
public class UserService {
    ...
    public void register() {
        ...
        System.out.println("Tebrikler kayit islemi gerceklesmistir.");
    ...
    public static boolean validateEmail(String email) {
        ...
        if (space) {
            ...
            if (!checkFirst) {
                System.out.println("Email buyuk-kucuk harf,rakam yada -._ karakterler disinda  karater icermez");
