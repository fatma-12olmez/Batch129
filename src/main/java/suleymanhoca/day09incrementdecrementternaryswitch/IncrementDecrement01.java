package suleymanhoca.day09incrementdecrementternaryswitch;
...
public class IncrementDecrement01 {
    public static void main(String[] args) {
        ...
        //Example;Bir tane int variable olusturun ve onu iki sekilde 5 artirin
      ...
      //  h-=1;
        ...
        int m=15;
        int n=++m;//pre-increment cunki increment ,variable'in isminden once yazildi
