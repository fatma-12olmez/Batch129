package suleymanhoca.day17arraylists;
...
public class ArrayLists01 {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        ages.add(12);
        ages.add(10);
        ages.add(1,656);//1.index'e 656 koy
        ages.add(3,777);
        ages.add(888);
        ...
        ages.addAll(newAges);// hazir olan Liste baska liste ekleme
        ages.addAll(2,newAges);//2.index'ten itibaren ekle
        System.out.println(ages); //[9, 656, 12, 777, 10, 888, 8, 9, 10]

        //Bir List'teki tum elemanlari nasil silebilirim?
       // ages.clear(); //hepsini siler
        System.out.println(ages);//[]
        ...
        Collections.sort(nums1);
                                 //iki list'i kucukten buyuge dizdikten sonra equals()'la karsilastirima yapilir
