...
public class Student {
    /*
    1)static variable veya static method'lar(class member) tum object'ler icin ortak elemandir.[class member=variable ve methodlar]
    ...
    public static String stdName = "Tom Hanks";//static oldugu icin runner sinifindan ulasabildik

    public int age = 13;//non-static oldugu icin runner 'da object olusturuldu.sonra ulasilabildi
