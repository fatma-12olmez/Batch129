...
public class Lambda03 {
    ...
    public static void main(String[] args) {
        ...
        //1)Tum "avarageScore"larin 91 den buyuk olup olmadigini kontrol kodu yaziniz.
        ...
        String name1 = coursesList.
                ...
                findFirst().
                get().
                getCourseName();//findFirst() ilk elemani verir
        ...
        List<Course> yourList = coursesList.
                stream().
                sorted(Comparator.comparing(Course::getAverageScore)).
                limit(3).//ilk ucunu yazacak
                        collect(Collectors.toList());
        System.out.println(yourList);
        //5)Tum course object'lerini average score'a gore kucukten buyuge diziniz ve  ucuncuyu console'a yazdiriniz.
