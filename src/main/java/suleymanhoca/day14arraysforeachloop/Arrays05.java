...
public class Arrays05 {
    public static void main(String[] args) {
        ...
        //Note 4:"binarySearch()" method'u bir elemanin bir array'de olup olmadigini kontrol etmek icin kullanilir
       ...
       int num1= Arrays.binarySearch(colors,"Blue");
        System.out.println(num1); //0==>var hemde index'i 0

        int num2= Arrays.binarySearch(colors,"Orange");
        System.out.println(num2);//3==>var hemde index'i 3

        int num3= Arrays.binarySearch(colors,"Tarik");
        System.out.println(num3);  // "-" bu eleman yok demek
                                  // "6"ise olsaydi  6.eleman olurdu
    }
