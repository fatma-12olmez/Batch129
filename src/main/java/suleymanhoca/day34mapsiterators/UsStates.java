package suleymanhoca.day34mapsiterators;

public enum UsStates {

    /*
    "enum" bir data deposudur.

     Sabit, degisme ihtimali olmayan datalari koyariz.
     Ornegin; haftanin gunleri ,yilin aylari, Amerikanin eyaletleri  etc...
     sabit datalari application'un icine gommek icin "enum" kullaniriz
     Cunku application'lar kendi basina(stand alone) ayakta duruyor olabilmelidir.
     /*
