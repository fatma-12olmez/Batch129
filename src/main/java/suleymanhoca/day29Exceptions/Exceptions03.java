...
import selfstudy.whileloop.WhileLoop01;
...
public class Exceptions03 {
    /*
       1)FileNotFoundException ve IOException Compile Time Exception’lardir, yani code’u yazarken hata aliriz.
        ...
        5)IOException Class ve FileNotFoundException beraber kullanilacaksa FileNotFoundException ustte(child oldugu icin), IOException altta kullanilmalidir.
     */

    public static void main(String[] args) {

        try {
            FileInputStream  fis=new FileInputStream("src\\main\\java\\suleymanhoca\\day29Exceptions\\File01.txt");
