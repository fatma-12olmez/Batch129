package suleymanhoca.day26overriding;
...
public class Animal {
  ...
  6)Child Class'daki override edilmis method(Overriding Method)'un access modifier'i Parent Class'daki override
   ...
   8)Method'un return type'i "primitive" ise, Overriding yaparken return type degistirilemez. Cunku return type ya  ayni olur ya da parent'dan secilir ama
 ...
 ********** Note: inheritance yoksa overriding den bahsedilemez**********
